...
function HomePage() {
  ...
  return (
    <div className='homepage w-screen h-screen flex-col bg-[#020202] text-white flex items-center justify-center'>
      <div id="mockup" className='w-[90%] md:w-[70%] lg:w-[50%] xl:w-[40%] flex items-center border-2 border-[violet] justify-center flex-col py-5 rounded-xl h-[80%] md:h-[70%] lg:h-[60%] xl:h-[50%]'>
